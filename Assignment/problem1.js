...
var ArrayOperations = /** @class */ (function () {
    ...
    ArrayOperations.prototype.getArray = function () {
        var rows = Number(promptSync("Enter the number of rows:"));
        var columns = Number(promptSync("Enter the number of columns:"));
        ...
        for (var i = 0; i < rows; i++) {
            ...
            for (var j = 0; j < columns; j++) {
                row.push(Number(promptSync("Enter value for array 1 at position (".concat(i + 1, ", ").concat(j + 1, "):"))));
            }
        ...
        for (var i = 0; i < rows; i++) {
            var row = [];
            for (var j = 0; j < columns; j++) {
                row.push(Number(promptSync("Enter value for array 2 at position (".concat(i + 1, ", ").concat(j + 1, "):"))));
            }
            this.array2.push(row);
        }
    };
    // Function to add the two arrays
    ArrayOperations.prototype.addArray = function () {
        var rows = this.array1.length;
        var columns = this.array1[0].length;
        this.sumArray = [];
        for (var i = 0; i < rows; i++) {
            var row = [];
            for (var j = 0; j < columns; j++) {
    ...
    ArrayOperations.prototype.displayArray = function () {
